    ...
    <div className='h-screen w-full bg-black/40 p-2 overflow-hidden'>
      <div className='main flex justify-between h-screen w-full mt-2'>
        ...
        <div className='right w-[50%]  h-[97%] p-5 overflow-scroll scrollbar-hide bg-black/40 rounded-[5px]'>
         {
          review || improve || testCase ? <Markdown >{review || improve || testCase}</Markdown> : <div className="h-full w-full flex justify-center items-center text-5xl opacity-40 text-center flex-col">Welcome to bitCheck<span className="mt-4">Playground!</span></div>
         }
        </div>
      </div>
    </div>

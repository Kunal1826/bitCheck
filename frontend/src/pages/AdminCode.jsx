...
const ReviewCodePage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-black text-white px-4 py-2 md:px-10">
      {/* NavBar */}
      <div className="flex justify-between items-center py-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="bg-gradient-to-r from-red-600 to-red-400 text-black font-medium border border-red-500 rounded-md px-3 py-1 md:px-4 md:py-2 text-sm md:text-base hover:scale-105 transition-transform"
          >
            Reject Code
          </button>
        </div>
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 px-4">
          <div className="bg-zinc-800 p-6 rounded-xl shadow-lg w-full max-w-md flex flex-col gap-4">
